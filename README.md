Для реализации процесса обнаружения аномальных записей в лог-файлах воспользовались решениями LogBert и DeepLog. Результаты можно найти в папке 'output' (некоторые файлы отсутствуют из-за их размеров).
